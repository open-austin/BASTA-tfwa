...
const TenantDetails: React.FC<TParams> = (props: TParams) => {
  ...
  const inputClass = isInEditMode ? styles.formControl : styles.readOnlyInput;
  const [tenantData] = useMutation(ADD_TENANT);
  const location = useLocation();
  const tenantId = props?.tenantId;
  console.log(`tenantId ${tenantId}`);
  console.log(
    `tenantId location ${location.pathname.split("/dashboard/tenant/")[1]}`
  );
  //console.log(`tenantId location ${location.state}`)
            ...
            <div className="col-lg-4">
              <div className="card mb-3">
                <div className="card-body text-center shadow">
                  ...
                  />
                  <div className="mb-3">
                    <button className={styles.bastaBtn}>
